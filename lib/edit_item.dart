...
class EditItem extends StatefulWidget {
  ...
  EditItem(this.category, this.name, this.quantity, this.id);
}
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value?.trim() == '' || value == null) {
                          return "من فضلك قم بتعديل اسـم الصنف";
                        }
                        return null;
                      },
                        ...
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            ...
                            showLoading(context, 'تحميل...',
                                isCancellable: false);
                            print(widget.id);
                            updateDataFromFirebase(widget.category, i).then((value) {
                              hideLoading(context);
